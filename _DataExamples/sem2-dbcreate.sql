...
CREATE DATABASE [Sem2-PurchaseOrders]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'VOSPlzen-PO-Client', FILENAME = N'C:\Database\MSSQL\Data\VOSPlzen-PurchaseOrders.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'VOSPlzen-PO-Client_log', FILENAME = N'C:\Database\MSSQL\Data\VOSPlzen-PurchaseOrders_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
